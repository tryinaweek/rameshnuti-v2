    ...
    <div>
      ...
      <section className="bg-midnight py-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-[linear-gradient(90deg,#1A1A3E_0%,#4ADE80_100%)]" />
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-14">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-lg bg-teal-mint/20 flex items-center justify-center text-teal-mint text-lg">
              &#9654;
            </div>
            <h2 className="text-xl font-bold text-midnight">Essential AI Skills for 2026</h2>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-lg bg-violet-400/20 flex items-center justify-center text-violet-400 text-lg">
              &#9889;
            </div>
            <h2 className="text-xl font-bold text-midnight">20+ AI Agents (Steal These)</h2>
          </div>
          <p className="text-text-secondary text-sm leading-relaxed">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-lg bg-terra-400/20 flex items-center justify-center text-terra-400 text-lg">
              &#128161;
            </div>
            <h2 className="text-xl font-bold text-midnight">Free Prompting Course (14 Days)</h2>
          </div>
          <p className="text-text-secondary text-sm leading-relaxed">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6">
          ...
          <div className="space-y-2 mb-8">
            {promptIngredients.map((item) => (
              <div key={item.num} className="flex items-start gap-3 rounded-lg bg-surface p-3">
          ...
          <div className="space-y-2">
            {vibeCodingFundamentals.map((item, index) => (
              <div key={index} className="flex items-start gap-3 rounded-lg bg-surface p-3">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {apps.map((app) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white border border-gray-100 rounded-xl p-5 no-underline hover:border-teal-mint transition-colors group"
              >
                <h3 className="text-sm font-bold text-midnight group-hover:text-teal-mint transition-colors">
                  {app.name}
                </h3>
